// Generated by CoffeeScript 1.7.1 (and modified to support cursor navigation over search results)
(function() {
  ...
  this.LunrSearch = (function() {
    ...
    LunrSearch.prototype.displayResults = function(entries) {
      ...
      $entries.empty();
      if (entries.length === 0) {
        $entries.append("<article class='noresults'><h1>Nothing found</h1></article>");
      } else {
